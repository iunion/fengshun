...
@implementation NSString (BMFormat)

- (NSString *)bm_formatWithPattern:(NSString *)pattern
{
    return [self bm_formatWithPattern:pattern placeholder:kDefaultPlaceholder];
}

- (NSString *)bm_formatWithPattern:(NSString *)pattern placeholder:(NSString *)placeholder
{
    return [self bm_formatWithPattern:pattern placeholder:kDefaultPlaceholder errorContinue:NO];
}

- (NSString *)bm_formatWithPattern:(NSString *)pattern placeholder:(NSString *)placeholder errorContinue:(BOOL)errorContinue
{
    if (![pattern bm_isNotEmpty])
    {
        return nil;
    }
    ...
    return [self bm_formatWithRegex:regex placeholder:placeholder errorContinue:errorContinue];
}

- (NSString *)bm_formatWithRegex:(NSRegularExpression *)regex
{
    return [self bm_formatWithRegex:regex placeholder:kDefaultPlaceholder];
}

- (NSString *)bm_formatWithRegex:(NSRegularExpression *)regex placeholder:(NSString *)placeholder
{
    return [self bm_formatWithRegex:regex placeholder:placeholder errorContinue:NO];
}

- (NSString *)bm_formatWithRegex:(NSRegularExpression *)regex placeholder:(NSString *)placeholder errorContinue:(BOOL)errorContinue
{
    if (!regex)
    {
        return nil;
    ...
    // Empty placeholder (@"")
    if (![placeholder bm_isNotEmpty])
    {
        placeholder = nil;
    }
    
    NSString *validCharacters = [self bm_validCharactersWithRegex:regex errorContinue:errorContinue];
...
- (NSString *)bm_validCharactersWithRegex:(NSRegularExpression *)regex errorContinue:(BOOL)errorContinue
{
    if (!regex)
    {
        return nil;
...
@implementation NSString (BMPhoneNumber)

- (NSString *)bm_maskPhoneNumber:(NSRange)maskRang withMask:(char)maskChar
{
    if (![self bm_isValidPhoneNumber])
    {
        return self;
    }
    
    return [self bm_maskAtRang:maskRang withMask:maskChar];
}

- (NSString *)bm_maskAtRang:(NSRange)maskRang withMask:(char)maskChar
{
