...
extern CGFloat const BMTableViewSectionHeaderHeightAutomatic;
extern CGFloat const BMTableViewSectionFooterHeightAutomatic;

@class BMTableViewManager;
@class BMTableViewCellStyle;

NS_ASSUME_NONNULL_BEGIN

@interface BMTableViewSection : NSObject

// The table view manager of this section.
@property (nullable, nonatomic, weak) BMTableViewManager *tableViewManager;

// The object that provides styling for the section. See BMTableViewCellStyle reference for details.
