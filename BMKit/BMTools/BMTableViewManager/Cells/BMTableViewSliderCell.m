...
@interface BMTableViewSliderCell ()

@property (nonatomic, assign) BOOL enabled;
@property (nonatomic, assign) BOOL sliderable;

@property (nonatomic, strong) BMSliderItem *item;

@property (nonatomic, strong) UISlider *sliderView;

@end

@implementation BMTableViewSliderCell
...
- (void)setItem:(BMSliderItem *)item
{
    if (_item != nil)
    {
        [_item removeObserver:self forKeyPath:@"enabled"];
...
{
    if ([object isKindOfClass:[BMSliderItem class]] && [keyPath isEqualToString:@"enabled"])
    {
        BOOL newValue = [[change objectForKey: NSKeyValueChangeNewKey] boolValue];
        
        self.enabled = newValue;
    }
    else if ([object isKindOfClass:[BMSliderItem class]] && [keyPath isEqualToString:@"sliderable"])
    {
        BOOL newValue = [[change objectForKey: NSKeyValueChangeNewKey] boolValue];
