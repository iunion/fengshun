...
- (void)cellLayoutSubviews
{
    ...
    [self.segmentView bm_centerVerticallyInSuperViewWithLeft:self.contentView.bm_width-self.segmentView.bm_width-margin];
...
- (void)setItem:(BMSegmentItem *)item
{
    if (_item != nil)
    {
        [_item removeObserver:self forKeyPath:@"enabled"];
...
- (void)setDisableItems:(NSArray *)disableItems
{
    ...
    if ([_disableItems bm_isNotEmpty])
    {
...
{
    if ([object isKindOfClass:[BMSegmentItem class]] && [keyPath isEqualToString:@"enabled"])
    {
        BOOL newValue = [[change objectForKey: NSKeyValueChangeNewKey] boolValue];
        
        self.enabled = newValue;
    }
    else if ([object isKindOfClass:[BMSegmentItem class]] && [keyPath isEqualToString:@"segmentable"])
    {
        BOOL newValue = [[change objectForKey: NSKeyValueChangeNewKey] boolValue];
        
        self.segmentable = newValue;
    }
    else if ([object isKindOfClass:[BMSegmentItem class]] && [keyPath isEqualToString:@"disableItems"])
    {
