...
{
    // Default FirstLetter
    BMChineseSortMode_System = 1,
    BMChineseSortMode_FirstLetter
};
 ...
 */
@property (nonatomic, assign) BMChineseSortMode sortMode;
/**
...
+ (void)sortAndGroup:(NSArray *)objectArray key:(NSString *)key finish:(BMChineseSortFinishBlock)finish;
