//
//  DJFreshBackContainerFooterView.m
...
@interface BMFreshBackContainerFooterView ()
...
@implementation BMFreshBackContainerFooterView
...
- (UILabel *)messageLabel
{
    if (!_messageLabel)
    {
        ...
        label.text = BMFRESH_DEFAULT_NORMALFOOTERTEXT;
        _messageLabel = label;
...
- (void)prepare
{
    ...
    [self setFreshTitle:BMFRESH_DEFAULT_NORMALFOOTERTEXT forState:BMFreshStateIdle];
