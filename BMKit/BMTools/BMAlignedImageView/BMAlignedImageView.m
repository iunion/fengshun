...
@interface BMAlignedImageView ()

@property (nonatomic, strong) UIImageView *realImageView;

@end

@implementation BMAlignedImageView
...
- (void)commonInitWithImage:(UIImage *)image highlightedImage:(UIImage *)highlightedImage
{
    ...
    _horizontallyAlignment = BMImageViewHorizontallyAlignmentCenter;
    _verticallyAlignment = BMImageViewVerticallyAlignmentCenter;
...
- (void)setHorizontallyAlignment:(BMImageViewHorizontallyAlignment)horizontallyAlignment
{
...
- (void)setVerticallyAlignment:(BMImageViewVerticallyAlignment)verticallyAlignment
{
...
- (void)layoutSubviews
{
    ...
    if (self.horizontallyAlignment == BMImageViewHorizontallyAlignmentLeft)
    {
        realframe.origin.x = 0;
    }
    else if (self.horizontallyAlignment == BMImageViewHorizontallyAlignmentRight)
    {
        realframe.origin.x = CGRectGetMaxX(self.bounds) - realframe.size.width;
    }
    
    if (self.verticallyAlignment == BMImageViewVerticallyAlignmentTop)
    {
        realframe.origin.y = 0;
    }
    else if (self.verticallyAlignment == BMImageViewVerticallyAlignmentBottom)
    {
