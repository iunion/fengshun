...
// 获取帖子分享信息
+ (nullable XMRequest *)getShareContent:(NSString *)relateId
                                   type:(NSString *)type
...
+ (nullable XMRequest *)addShareCountWithId:(NSString *)objId andType:(NSString *)type
                                    success:(nullable XMSuccessBlock)successBlock
                                    failure:(nullable XMFailureBlock)failureBlock;
...
+ (nullable XMRequest *)completeUserMessageWithRealName:(NSString *)realName idCard:(NSString *)idCard nikeName:(NSString *)nikeName Success:(nullable XMSuccessBlock)successBlock
                                                failure:(nullable XMFailureBlock)failureBlock;
...
+ (nullable XMRequest *)getCollectStateID:(NSString *)relateId
                                     type:(NSString *)type
                                  Success:(nullable XMSuccessBlock)successBlock
                                  failure:(nullable XMFailureBlock)failureBlock;
/**
 ...
 @return XMRequest
 */
+ (nullable XMRequest *)updateCollectStateID:(NSString *)relateId isCollect:(BOOL)isCollect guidingCase:(NSString *)guidingCase source:(NSString *)source title:(NSString *)title type:(NSString *)type Success:(XMSuccessBlock)successBlock failure:(XMFailureBlock)failureBlock;
...
+ (nullable XMRequest *)getCaseSearchHotkeysSuccess:(nullable XMSuccessBlock)successBlock
                                            failure:(nullable XMFailureBlock)failureBlock;
...
+ (nullable XMRequest *)getCaseKeywordsWithText:(NSString *)text success:(nullable XMSuccessBlock)successBlock failure:(nullable XMFailureBlock)failureBlock;

// 获取法规检索的法规专题
// http://122.112.248.222:13000/swagger-ui.html#!/391183584329702390348212821227861352682562832034/casesHotKeywordsUsingGET_1
+ (nullable XMRequest *)getLawTopicSuccess:(nullable XMSuccessBlock)successBlock
                                   failure:(nullable XMFailureBlock)failureBlock;
...
+ (nullable XMRequest *)getLawsKeywordsWithText:(NSString *)text success:(nullable XMSuccessBlock)successBlock failure:(nullable XMFailureBlock)failureBlock;

// 文书范本Index页数据
// http://115.159.33.190:8121/swagger-ui.html#/%E6%96%87%E4%B9%A6%E8%8C%83%E6%9C%AC/getDocumentHomeUsingPOST
+ (nullable XMRequest *)loadTextIndexPageDataSuccess:(nullable XMSuccessBlock)successBlock
                                             failure:(nullable XMFailureBlock)failureBlock;
...
+ (nullable XMRequest *)getTwoLevelFourmInfoWithId:(NSInteger)topicId
                                           success:(nullable XMSuccessBlock)successBlock
                                           failure:(nullable XMFailureBlock)failureBlock;
...
+ (nullable XMRequest *)updateFourmAttentionStateWithFourmId:(NSInteger)fourmId
...
+ (nullable XMRequest *)sendPostsWithTitle:(NSString *)title
...
+ (nullable XMRequest *)getTopicDetail:(NSInteger)topicId
                               success:(nullable XMSuccessBlock)successBlock
                               failure:(nullable XMFailureBlock)failureBlock;
// 添加评论
+ (nullable XMRequest *)addComment:(NSString *)topicId
                           content:(NSString *)content
                           success:(nullable XMSuccessBlock)successBlock
                           failure:(nullable XMFailureBlock)failureBlock;
// 上传图片
+ (nullable XMRequest *)uploadImg:(NSData *)imgData
                          success:(nullable XMSuccessBlock)successBlock
                          failure:(nullable XMFailureBlock)failureBlock;

// 删除帖子
+ (nullable XMRequest *)deleteTopicWithId:(NSInteger)topicId
                                  success:(nullable XMSuccessBlock)successBlock
                                  failure:(nullable XMFailureBlock)failureBlock;
// 收藏、取消收藏帖子
+ (nullable XMRequest *)collectionTopic:(BOOL)isCollection
                                topicId:(NSString *)topicId
                                success:(nullable XMSuccessBlock)successBlock
                                failure:(nullable XMFailureBlock)failureBlock;
// 举报帖子/评论
+ (nullable XMRequest *)addReportTopic:(NSString *)topicId
                               content:(NSString *)content
                                  type:(NSString *)type
                               success:(nullable XMSuccessBlock)successBlock
                               failure:(nullable XMFailureBlock)failureBlock;
