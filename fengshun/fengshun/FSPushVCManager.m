...
{
    NSString *url = [NSString stringWithFormat:@"%@/Law?keywords=%@",FS_CASE_STATUTE_H5,lawTopic];
...
{
    [FSPushVCManager showWebView:vc url:[NSString stringWithFormat:@"%@/law/lawDetail?ID=%@&keywords=%@",FS_CASE_STATUTE_H5,lawId,keywordsStr] title:nil showLoadingBar:YES loadingBarColor:FS_LOADINGBAR_COLOR animated:YES];
}
// 案件详情
...
{
    [self showWebView:vc url:[NSString stringWithFormat:@"%@%@?ID=%@&keywords=%@",FS_CASE_STATUTE_H5,isGuide?@"/caseGuide":@"/caseDetail",caseId,keywordsStr] title:nil showLoadingBar:YES loadingBarColor:FS_LOADINGBAR_COLOR animated:YES];
