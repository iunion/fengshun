...
@interface ORDTextView ()

@property (nonatomic, copy) ORDTextViewHandler changeHandler; ///< 文本改变Block
@property (nonatomic, copy) ORDTextViewHandler maxHandler; ///< 达到最大限制字符数Block
@property (nonatomic, strong) UILabel *placeholderLabel; ///< placeholderLabel

@end

@implementation ORDTextView
...
- (void)addTextDidChangeHandler:(ORDTextViewHandler)changeHandler{
