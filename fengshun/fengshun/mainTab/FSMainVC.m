...
- (void)configBanner
{
    ...
    self.m_bannerView = [[FSPageBannerView alloc] initWithFrame:CGRectMake(0, 0, UI_SCREEN_WIDTH, 140) scrollDirection:FSBannerViewScrollDirectionLandscape images:dataArray pageWidth:UI_SCREEN_WIDTH - 80.0f padding:0];
